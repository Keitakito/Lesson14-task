...
/**
 * Servlet implementation class EmployeesUpdataServlet
 */
@WebServlet(name = "employees/updata", urlPatterns = { "/employees/updata" })
public class EmployeesUpdataServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public EmployeesUpdataServlet() {
        super();
